...
EOF;
      ...
      unlink($targetDir.'/autoload_namespaces.php');
      unlink($targetDir.'/autoload_psr4.php');
      unlink($targetDir.'/autoload_classmap.php');
...
// autoload_real.php @generated by Composer + Composer Min Autoload plugin
